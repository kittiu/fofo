...
class fofo_sales_report(models.TransientModel):
    _name = 'fofo.sale.report'
    ...
    category_ids = fields.Many2many('res.partner.category', string='Partner Tags')
    ...
    def print_report(self, data):
        ...
        data['form'] = self.read(['date_from',  'date_to', 'customer_ids','company_id', 'category_ids','fiscalyear_id', 'period_from', 'period_to',  'filter'])[0]
        ...
        return self.pool['report'].get_action(self._cr, self._uid, [], 'fofo_sales_report.fofo_sales_report', data=data, context=self.env.context)#probuse
